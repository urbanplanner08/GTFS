...
<%@ page import="search.Routesearch"%>
<%@ page import="search.Stop"%>
...
<script type="text/javascript">
  ...
  var examples = [
                  <% int count2=0;
                     int max=(int)Math.floor(count/10);
                  for (int i=0;i<max;i++)
                  { 
                	  int bound=9+i*9;
                  %>  {   
...
<img src="brt.jpg" height="100" width="180" />
  ...
  <table class="CSSTableGenerator" style="width:90%;margin-left:auto;margin-right:auto">
    <tr>
    <%for(int i=0;i<(stopname.size()+10)/10;i++)
    	{%> 
...
<%} %>
  ...
  <tr>
    ...
    <td><li class="stopList"><a class="fakebutton" href="stop.jsp"> Stop Page </a></li>   </td>
    <td><li class="stopList"><a class="fakebutton" href="statistics.jsp"> Statistics Page </a></li>   </td>
  </tr>
  </table>

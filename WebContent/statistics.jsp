...
function Tour_startUp(stops) {
    if (!window.tour) window.tour = {
        ...
        loadMap: function (map, directionsDisplay) {
            var myOptions = {
                zoom: 13,
                center: new window.google.maps.LatLng(30.25, -97.75), // default to London
...
if (parseFloat(legs[i].distance.text)>16)
...
<div style="float:right;margin-right:7%">
				...
				<li class="stopList"><a class="fakebutton" href="home.jsp">
						Home Page </a></li>  
						<br />
						<li class="stopList"><a class="fakebutton" href="elevation.jsp">

...
<%@ page import="search.AlbanyStop"%>
   ...
   <%
					...
					ArrayList stopseq= new ArrayList();
						...
						ResultSet rs = null;
						AlbanyStop stop = new AlbanyStop();
...
<%} %>
  ...
  <tr>
    ...
    <td><li class="stopList"><a class="fakebutton" href="albanystop.jsp"> Stop Page </a></li>   </td>
    <td><li class="stopList"><a class="fakebutton" href="albanystatistics.jsp"> Statistics Page </a></li>   </td>
  </tr>
  </table>
